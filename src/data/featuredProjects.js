const featuredProjects = [
  ...
  },
  {
    ...
    summary:
      'Procedural city layout prototype exploring graph-based roads, zoning, and lighting to stress-test simulation ideas.',
    tech: ['C++', 'Noise generation', 'Graph algorithms'],
    role: 'Systems programmer',
    liveUrl: 'https://github.com/jonhef/city-generator#readme',
    githubUrl: 'https://github.com/jonhef/city-generator',
  },
  {
    title: 'smshubapi',
